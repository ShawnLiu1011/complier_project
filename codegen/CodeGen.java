...
public class CodeGen {
    ...
    public static void genJumpAndLink(PrintWriter p, String funcName) {
        if(funcName.equals("main")) {
            generate(p, "jal", funcName);
        } else {
            generate(p, "jal", "_"+funcName);
        }
    }

    public static void genAddr(PrintWriter p, String identify) {
        generate(p, "la", T0, identify);
        genPush(p, T0);
    }

    public static void genAddr(PrintWriter p, int offset) {
        generateIndexed(p, "la", T0, FP, offset);
        genPush(p, T0);
    }
} 
